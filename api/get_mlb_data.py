...
schedule = api_tools.get_mlb_schedule(start_date=(datetime.now().date() - timedelta(days=7)).strftime('%Y-%m-%d'),
...
game_data = api_tools.get_mlb_game_data(start_date=(datetime.now() - timedelta(days=7)).strftime('%Y-%m-%d')
                                       ,end_date=(datetime.now() - timedelta(days=1)).strftime('%Y-%m-%d')
                                       ,verbose=False)
if game_data:
...
at_bats = api_tools.get_mlb_at_bats(start_date=(datetime.now() - timedelta(days=7)).strftime('%Y-%m-%d')
                                    ,end_date=(datetime.now() - timedelta(days=1)).strftime('%Y-%m-%d')
                                    ,verbose=False)
